# Proof of Existence Substrate (follow tutorial)[https://docs.substrate.io/tutorials/v3/proof-of-existence/]

- [x] Build and compile the pallet
- [ ] Build the frontend to interact with the pallet
